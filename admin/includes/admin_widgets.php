        ...
        <div class="panel panel-green">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class='huge'><?php echo $comm_num; ?></div>
                        <div>Comments</div>
                    </div>
                </div>
            </div>
            ...
            var data = google.visualization.arrayToDataTable([
                ['Data', 'Count'],
                    <?php
                            ...
                            $element_num= [$post_num, $post_active_num, $post_draft_num, $comm_num, $comm_un_num, $user_num, $subs_num, $cat_num];
                for($i =0; $i<8; $i++){
                    echo "['{$element_text[$i]}'" . "," . "{$element_num[$i]}],";
